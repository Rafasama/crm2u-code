...
class EMAILMaker_Display_Model extends Vtiger_Base_Model {
    ...
    public function CheckDisplayConditions($emailtemplateResult,$Entry,$formodule){        
        $v = true;
        $Fields = array();
        ...
        if ($emailtemplateResult["conditions"] != "") {
            $Load_Conditions = Zend_Json::decode(decode_html($emailtemplateResult["conditions"]));
            ...
            if (count($Conditions) > 0) {
                ...
                $DisplayModel = EMAILMaker_Display_Model::getInstance($formodule, '0', $Fields);
