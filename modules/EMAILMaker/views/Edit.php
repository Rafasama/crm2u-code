    ...
    public function process(Vtiger_Request $request){
        ...
        if ($request->has('record') && !$request->isEmpty('record')){
            ...
            if (vtlib_isModuleActive("ITS4YouStyles")){
                ...
                $Style_Content = $ITS4YouStylesModuleModel->getStyleContent($templateid,"EMAILMaker","ASC");
...
// ******************************************   Company and User information: **********************************
        ...
        $CUI_BLOCKS["Account"] = vtranslate("LBL_COMPANY_INFO",'EMAILMaker');
...
//custom functions
        ...
        //Constructing the Group Array
            ...
            $vatblock_table = '<table border="1" cellpadding="3" cellspacing="0" style="border-collapse:collapse;">
                                    ...
                                    <td>' . vtranslate("LBL_VATBLOCK_VAT_PERCENT",'EMAILMaker') . '</td>
                                    <td>' . vtranslate("LBL_VATBLOCK_SUM",'EMAILMaker') . '</td>
                                    <td>' . vtranslate("LBL_VATBLOCK_VAT_VALUE",'EMAILMaker') . '</td>
                                </tr>
                                        <tr>
