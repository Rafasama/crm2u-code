<?php /* Smarty version Smarty-3.1.7, created on 2017-05-12 12:41:49
         compiled from "/home/rz2ac608/public_html/crm2u.com.br/teste/includes/runtime/../../layouts/mazzy/modules/Vtiger/RelatedList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4097644665915ad8dc40933-40684820%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dde07965c3817af7eb6f1ef0b7c12c1ed7a53806' => 
    array (
      0 => '/home/rz2ac608/public_html/crm2u.com.br/teste/includes/runtime/../../layouts/mazzy/modules/Vtiger/RelatedList.tpl',
      1 => 1494587708,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4097644665915ad8dc40933-40684820',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5915ad8e10d25',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5915ad8e10d25')) {function content_5915ad8e10d25($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/home/rz2ac608/public_html/crm2u.com.br/teste/libraries/Smarty/libs/plugins/modifier.truncate.php';
?>
...
"<?php }?><?php if ($_smarty_tpl->tpl_vars['IS_SELECT_BUTTON']->value!=true){?>name="addButton"<?php }?>><?php if ($_smarty_tpl->tpl_vars['IS_SELECT_BUTTON']->value==false){?><i class="fa fa-plus"></i><?php }?>&nbsp;<strong><?php echo $_smarty_tpl->tpl_vars['RELATED_LINK']->value->getLabel();?>
...
'<?php }?>><td nowrap class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
 "><div class="actions"><span class="actionImages"><?php if ($_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value=='Calendar'){?><?php if ($_smarty_tpl->tpl_vars['IS_EDITABLE']->value&&$_smarty_tpl->tpl_vars['RELATED_RECORD']->value->get('taskstatus')!='Held'&&$_smarty_tpl->tpl_vars['RELATED_RECORD']->value->get('taskstatus')!='Completed'){?><a class="btn btn-darkyellow btn-xs markAsHeld"><i title="<?php echo vtranslate('LBL_MARK_AS_HELD',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" class="fa fa-check alignMiddle"></i></a><?php }?><?php if ($_smarty_tpl->tpl_vars['IS_EDITABLE']->value&&$_smarty_tpl->tpl_vars['RELATED_RECORD']->value->get('taskstatus')=='Held'){?><a class="btn btn-orange btn-xsholdFollowupOn"><i title="<?php echo vtranslate('LBL_HOLD_FOLLOWUP_ON',"Events");?>
" class="fa fa-flag alignMiddle"></i></a><?php }?><?php if ($_smarty_tpl->tpl_vars['DETAILVIEWPERMITTED']->value=='yes'){?><a class="btn btn-black btn-xs" href="<?php echo $_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getFullDetailViewUrl();?>
"><i title="<?php echo vtranslate('LBL_SHOW_COMPLETE_DETAILS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" class="fa fa-th-list alignMiddle"></i></a><?php }?><?php }else{ ?><a class="btn btn-black btn-xs" href="<?php echo $_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getFullDetailViewUrl();?>
"><i title="<?php echo vtranslate('LBL_SHOW_COMPLETE_DETAILS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" class="fa fa-th-list alignMiddle"></i></a><?php }?><?php if ($_smarty_tpl->tpl_vars['IS_EDITABLE']->value){?><?php if ($_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value=='PriceBooks'){?><a class="btn btn-yellow btn-xs" data-url="index.php?module=PriceBooks&view=ListPriceUpdate&record=<?php echo $_smarty_tpl->tpl_vars['PARENT_RECORD']->value->getId();?>
...
><i class="fa fa-pencil alignMiddle" title="<?php echo vtranslate('LBL_EDIT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"></i></a><?php }elseif($_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value=='Calendar'){?><?php if (isPermitted($_smarty_tpl->tpl_vars['RELATED_MODULE']->value->get('name'),'EditView',$_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getId())=='yes'){?><a class="btn btn-yellow btn-xs" href='<?php echo $_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getEditViewUrl();?>
'><i title="<?php echo vtranslate('LBL_EDIT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" class="fa fa-pencil alignMiddle"></i></a><?php }?><?php }else{ ?><a class="btn btn-yellow btn-xs" href='<?php echo $_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getEditViewUrl();?>
'><i title="<?php echo vtranslate('LBL_EDIT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" class="fa fa-pencil alignMiddle"></i></a><?php }?><?php }?><?php if ($_smarty_tpl->tpl_vars['IS_DELETABLE']->value){?><?php if ($_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value=='Calendar'){?><?php if (isPermitted($_smarty_tpl->tpl_vars['RELATED_MODULE']->value->get('name'),'Delete',$_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getId())=='yes'){?><a class="btn btn-red btn-xs relationDelete"><i title="<?php echo vtranslate('LBL_DELETE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" class="fa fa-trash alignMiddle"></i></a><?php }?><?php }else{ ?><a class="btn btn-red btn-xs relationDelete"><i title="<?php echo vtranslate('LBL_DELETE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" class="fa fa-trash alignMiddle"></i></a><?php }?><?php }?></span></div></td><?php  $_smarty_tpl->tpl_vars['HEADER_FIELD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['HEADER_FIELD']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['RELATED_HEADERS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['HEADER_FIELD']->total= $_smarty_tpl->_count($_from);
 $_smarty_tpl->tpl_vars['HEADER_FIELD']->iteration=0;
foreach ($_from as $_smarty_tpl->tpl_vars['HEADER_FIELD']->key => $_smarty_tpl->tpl_vars['HEADER_FIELD']->value){
...
?><?php $_smarty_tpl->tpl_vars['RELATED_HEADERNAME'] = new Smarty_variable($_smarty_tpl->tpl_vars['HEADER_FIELD']->value->get('name'), null, 0);?><td class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
 rel-field" data-field-type="<?php echo $_smarty_tpl->tpl_vars['HEADER_FIELD']->value->getFieldDataType();?>
...
<?php if ($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value=='listprice'){?><?php $_smarty_tpl->tpl_vars["LISTPRICE"] = new Smarty_variable(CurrencyField::convertToUserFormat($_smarty_tpl->tpl_vars['RELATED_RECORD']->value->get($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value),null,true), null, 0);?><?php }?><?php }elseif($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value=='description'){?><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getDisplayValue($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value),100,' ...');?>
...
<?php }?><?php if ($_smarty_tpl->tpl_vars['HEADER_FIELD']->last){?></td><?php }?></td><?php } ?></tr><?php } ?></table></div></div></div>
<?php }} ?>