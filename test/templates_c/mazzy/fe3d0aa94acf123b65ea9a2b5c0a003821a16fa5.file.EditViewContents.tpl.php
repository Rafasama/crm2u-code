<?php /* Smarty version Smarty-3.1.7, created on 2017-05-12 13:31:24
         compiled from "/home/rz2ac608/public_html/crm2u.com.br/teste/includes/runtime/../../layouts/mazzy/modules/Settings/Profiles/EditViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7237340215915b92c48e473-01134170%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fe3d0aa94acf123b65ea9a2b5c0a003821a16fa5' => 
    array (
      0 => '/home/rz2ac608/public_html/crm2u.com.br/teste/includes/runtime/../../layouts/mazzy/modules/Settings/Profiles/EditViewContents.tpl',
      1 => 1494587708,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7237340215915b92c48e473-01134170',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5915b92ca24b5',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5915b92ca24b5')) {function content_5915b92ca24b5($_smarty_tpl) {?>
...
"></script><?php } ?><div class="row padding1per"><span class="span2"><h4><?php echo vtranslate('LBL_COPY_PRIVILEGES_FROM',"Settings:Roles");?>
...
</option><?php }?><?php } ?></select></span></div><div class="clearfix"></div><br><div class="summaryWidgetContainer"><label class="checkbox"><input type="hidden" name="viewall" value="0" /><input type="checkbox" name="viewall" <?php if ($_smarty_tpl->tpl_vars['RECORD_MODEL']->value->hasGlobalReadPermission()){?>checked="true"<?php }?> /><?php echo vtranslate('LBL_VIEW_ALL',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
<span style="margin-left:25px"><i class="btn btn-xs btn-blue fa fa-info-circle"></i><span style="margin-left:2px"><?php echo vtranslate('LBL_VIEW_ALL_DESC',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
<span style="margin-left:30px"><i class="btn btn-xs btn-blue fa fa-info-circle"></i><span style="margin-left:2px"><?php echo vtranslate('LBL_EDIT_ALL_DESC',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></span></label></div><div class="clearfix"></div><table class="table table-bordered profilesEditView"><thead><tr class="blockHeader"><th width="30%" style="border-left: 1px solid #DDD !important;"><input checked="true" class="alignTop" type="checkbox" id="mainModulesCheckBox" />&nbsp;<?php echo vtranslate('LBL_MODULES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
-fields" class="btn btn-mini" style="padding-right: 20px; padding-left: 20px;"><i class="fa fa-chevron-down"></i></button></span></div><?php }?></td></tr><tr class="hide"><td colspan="6" class="" ><div class=" hide" data-togglecontent="<?php echo $_smarty_tpl->tpl_vars['TABID']->value;?>
...
"></div><div class="pull-left"><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory()){?><span class="redColor">*</span><?php }?> <?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</div></td><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['fields']['last']||($_smarty_tpl->tpl_vars['COUNTER']->value+1)%3==0){?></tr><?php }?><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?><?php }?><?php } ?></table><?php }?></div></ul><?php }?></div></td></tr><tr class="hide"><td colspan="6" class="" style="padding-left: 5%;padding-right: 5%;background-image: none !important;"><div class="hide" data-togglecontent="<?php echo $_smarty_tpl->tpl_vars['TABID']->value;?>
-fields"><div class="span12" style="width: 100%;"><label class="themeTextColor font-x-large pull-left"><strong><?php echo vtranslate('LBL_TOOLS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</strong></label></div><div class="span12" style="width: 100%;"><table class="table table-bordered"><?php $_smarty_tpl->tpl_vars['UTILITY_ACTION_COUNT'] = new Smarty_variable(0, null, 0);?><?php $_smarty_tpl->tpl_vars["ALL_UTILITY_ACTIONS_ARRAY"] = new Smarty_variable(array(), null, 0);?><?php  $_smarty_tpl->tpl_vars['ACTION_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['ACTION_MODEL']->_loop = false;
...
</td><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['actions']['last']||($_smarty_tpl->getVariable('smarty')->value['foreach']['actions']['index']+1)%3==0){?></div><?php }?><?php } ?></table></div></td></tr><?php }?><?php } ?></tbody></table></div><div class="clearfix"></div>
<?php }} ?>