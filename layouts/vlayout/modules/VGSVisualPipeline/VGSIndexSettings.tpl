            ...
            <table class="table table-bordered listViewEntriesTable">
                ...
                {foreach item=RMU_FIELDS from=$RMU_FIELDS_ARRAY}
                    <tr class="listViewEntries">
                        ...
                        <td class="listViewEntryValue" nowrap> <a class="deleteRecordButton" id="{$RMU_FIELDS.id}" data-sourcemodule="{$RMU_FIELDS.source_module}"><i title="Delete" class="icon-trash alignMiddle"></i></a></td>
