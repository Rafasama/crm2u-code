        ...
        changeSteps: function(){
            ...
            if (next_step == "2") {
                ...
                if (next_step == "3") {
                    ...
                    if (!this.replacerelatedblock) {
                        CKEDITOR.replace('relatedblock', {height:'280'});
                        this.replacerelatedblock = true;
                    }
                }        
        ...
        changeSecOptions: function(){
            ...
            if (saved_secmodule != secmodule) {
                ...
                AppConnector.request(params).then(
                    function(data){
                        jQuery('#filter_columns').html("<option value=''>"+app.vtranslate("LBL_NONE","EMAILMaker")+"</option>" + data.result);
                        jQuery('#selectScolrow_1').html("<option value='' selected='selected'>"+app.vtranslate("LBL_NONE","EMAILMaker")+"</option>" + data.result);
                        jQuery('#selectScolrow_2').html("<option value='' selected='selected'>"+app.vtranslate("LBL_NONE","EMAILMaker")+"</option>" + data.result);
                        jQuery('#selectScolrow_3').html("<option value='' selected='selected'>"+app.vtranslate("LBL_NONE","EMAILMaker")+"</option>" + data.result);
	...
	registerSubmitEvent : function(){
        ...
        createRelatedBlockTable: function (){
            ...
            if (this.replacerelatedblock) {
                ...
                jQuery("#relatedblock").html(table);
