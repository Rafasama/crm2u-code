...
if (typeof(EMAILMaker_ImportJs) == 'undefined') {
    ...
    EMAILMaker_ImportJs = {
        checkFileType: function() {
            ...
            if (filePath != '') {
                ...
                EMAILMaker_ImportJs.handleFileTypeChange();
            } else
                return false;
        },
        ...
        uploadAndParse: function() {
            if (!EMAILMaker_ImportJs.validateFilePath())
                return false;
            return true;
        },
        validateFilePath: function() {
            ...
            if (!EMAILMaker_ImportJs.uploadFilter("import_file", "xml")) {
                return false;
            }
            if (!EMAILMaker_ImportJs.uploadFileSize("import_file")) {
                return false;
            }
            return true;
        },
        ...
        registerImportClickEvent: function() {
            jQuery('#importButton').on('click', function(e) {
                var result = EMAILMaker_ImportJs.checkFileType()
                return result;
            });
        }
    }
    jQuery(document).ready(function() {
        EMAILMaker_ImportJs.registerImportClickEvent();
    });
}