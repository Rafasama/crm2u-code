 ...
 * All Rights Reserved.
 ********************************************************************************/
if (typeof(EMAILMaker_ListJs) == 'undefined') {

    EMAILMaker_ListJs = {
        massDeleteTemplates : function(){	
            var listInstance = EMAILMaker_ListJs;
            var validationResult = listInstance.checkListTemplatesSelected();
                if(validationResult == true){
                    ...
                    Vtiger_Helper_Js.showConfirmationBox({'message' : message}).then(
                            function(e) {
                                var deleteURL = 'module=EMAILMaker&action=IndexAjax&mode=DeleteTemplate&ajaxDelete=true&idlist='+selectedIds;
