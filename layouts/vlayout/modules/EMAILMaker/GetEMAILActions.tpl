    ...
    <div class="row-fluid">
        <div class="span10">
            <ul class="nav nav-list">
                ...
                {* Send Email *}
                <li>
                    <a href="javascript:;" onclick="EMAILMaker_Actions_Js.emailmaker_sendMail('{$MODULE}','{$ID}','','','{$ID}');" class="webMnu" style="padding-left:10px;"><img src="layouts/vlayout/skins/images/Emails.png" hspace="5" align="absmiddle" border="0" style="border-radius:3px;" />&nbsp;{vtranslate('LBL_SEND_EMAIL')}</a>
                </li>
            </ul>
        </div>
        <br clear="all"/>
