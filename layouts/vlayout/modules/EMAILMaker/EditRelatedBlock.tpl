        ...
        <div class="contentsDiv marginLeftZero" >
            <div class="padding1per">
                <div style="position: relative; " class="row-fluid" >                
                    <label class="themeTextColor font-x-x-large">{vtranslate('LBL_EDIT_RELATED_BLOCK','EMAILMaker')}</label><hr>
                               ...
                               <div class="pushDown2per">     
                                                                ...
                                                                <td  style="padding-left: 5px; " align="left" width="75%" valign="top">
                                                                    {foreach item=relmod name=relmodule from=$RELATED_MODULES}
                                                                        <div class="marginBottom10px">
                                                                            <input type='radio' name="secondarymodule" {if $SEC_MODULE eq $relmod}checked{/if} value="{$relmod}" />
                                                                            {vtranslate($relmod)}
                                                                        </div> 
                                                                    {/foreach}
                                                                </td>
                                   ...
                                   {/if}
                                                ...
                                                <div class="filterContainer">
                                                    <div class="conditionGroup contentsBackground well">
                                                        <div class="row-fluid block">
                                                            <div class="row-fluid row span">
                                                                    <span class="span6">
                                                                            <strong>{vtranslate('LBL_SORT_BY','EMAILMaker')}</strong>
                                                                    </span>	
                                                                    <span class="span6">
                                        ...
                                        <div id="step5" class="hide">
                                            ...
                                            <div class="widget_contents row-fluid">
                                                ...
                                                <div class="row-fluid">
                                                    <textarea name="relatedblock" id="relatedblock" style="height:280px;width:1130px;">{$RELATEDBLOCK}</textarea>
                                                </div>
                                            </div>
                                        </div>  
                                       <!-- BUTTONS -->
                                       ...
                                       <hr>
                                            <div class="floatRight">
                                                ...
                                                &nbsp;<a name="cancel" class="cursorPointer cancelLink" value="Cancel" href="javscript:;" onClick="self.close();">{vtranslate('LBL_CANCEL',$MODULE)}</a>
                                            </div>
                                       </div>    
                                   </div>
                               </div>                 
