                                ...
                                {foreach name=langvals item=langvalsdata key=modulename from=$LANGVALSARR}
                                    <div class="control-group">
                                            ...
                                            <div class="controls input-append">
                                                ...
                                                <input type="text" name="LblVal{$langvalsdata.id}Value" class="input-large" placeholder="{vtranslate('LBL_ENTER_CUSTOM_LABEL_VALUE', 'EMAILMaker')}" value="{$langvalsdata.value}"/>
                                            </div>	
                                    </div>
                                {/foreach}            
                            </div>
